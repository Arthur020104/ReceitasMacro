# Generated by Django 4.0.2 on 2022-04-15 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calorias', models.FloatField(validators=[django.core.validators.MinValueValidator(100)])),
                ('carboidratos', models.FloatField()),
                ('proteinas', models.FloatField()),
                ('gorduras', models.FloatField()),
                ('timestamp', models.CharField(max_length=30)),
                ('modoPreparo', models.CharField(max_length=3000)),
                ('img', models.ManyToManyField(blank=True, related_name='imgs', to='ReceitasMacro.Img')),
